...
//
#include "yqm_chassis_controllers/reaction_wheel.h"
...
namespace yqm_chassis_controllers
{
...
PLUGINLIB_EXPORT_CLASS(yqm_chassis_controllers::ReactionWheelController, controller_interface::ControllerBase)
